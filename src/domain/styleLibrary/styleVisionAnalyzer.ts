              ...
              content: [
                {
                  ...
                  text: [
                    ...
                    "stylePrompt must describe only reusable visual direction: layout, background, environment, lighting, tone, camera, composition and commercial retouching. It must not copy product identity, logos, people, text, exact props, brand marks, bag-specific material, handle, strap, zipper path, hardware, pocket layout, colorway, or silhouette from the reference image.",
